    ...
    function toolbar(iframe) {
        ...
        var tb = $("<div class='rte-toolbar' id='toolbar-"+iframe.title+"'><div>\
            ...
            <p>\
                ...
                <a href='#' class='disable'><img width=50 src='"+media_url+"close.gif' alt='close rte' /></a>\
            </p></div></div>");
        ...
        $('.disable', tb).click(function() {
            ...
            var edm = $('<a href="#">Enable design mode with english(You are currently in bangla mood)</a>');
            tb.empty().append(edm);
            edm.click(function(){
