<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorldPlace.aspx.cs" Inherits="BDDoctors.WorldPlace" %>
...
<div id="content-area" style=""  >
        ...
        <div id="droppable"  style="width:760px;float:left; overflow:hidden; height:100%; background-color:Transparent; border:1px solid #916640">
              ...
              <% BDDoctors.DAL.DataObject.JagPlace ParentPlace=BDDoctors.DAL.DataAccess.jagPlace.GetJagPlaceById(Convert.ToInt32(Request["place_id"])); %>
                ...
                <%foreach(BDDoctors.DAL.DataObject.JagPlace objjagplace in BDDoctors.DAL.DataAccess.jagPlace.GetChildJagPlaceByParentIdAndLevel(Convert.ToInt32(Request["place_id"]),BDDoctors.DAL.DataObject.JagPlaceLevel.Building))  %>
                <%{ %>
