<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChatRoom.aspx.cs" Inherits="BDDoctors.ChatRoom" EnableEventValidation="false" ValidateRequest="false" %>
...
<body style=" background-color:#283227; background-repeat:repeat"  onload="turnAvatarInvisible();CheckPostBack();">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" ScriptMode=Release>
     ...
     <div class="main-div" style=" float:left;" runat="server" id=maindiv>
                ...
                <asp:UpdatePanel runat="server" ID="upanelMyAvatar" UpdateMode="Conditional">
                <ContentTemplate>  
                ...
                <span id="spnFlytext" style="position:absolute;color:#76d0e5; font-size:20px; z-index:40"></span>
                     <div runat="server" id="MyAvatar" style="width:150px;  top:200px;left:200px;position:absolute; z-index:5">
                             
                             <div id="dvMyAvtarTxtandButtonContainer"  style=" visibility:hidden; z-index:5; width:150px; height:90px;   background-image:url(Images/Site/callout.gif); background-repeat:no-repeat">
                            ...
                            <div runat="server" id="MyAvatarImgContainer" style="background-image:url(Images/AvatarChat/avatar/a1.png);  position:absolute;z-index:5; width:64px; height:64px;">
                              <a href="#" onclick=toogleHeightWidth(); style="">Talk</a>  
                            </div>
                ...
                <asp:LinkButton runat="server" ID="hlinkChangeRoom" Text="Change your world" Visible=false ></asp:LinkButton>
                  ...
                  <div>
                       <div style="background-color:Yellow; float:left; width:380px; overflow:auto; height:55px; float:left" >
                        <asp:DataList runat="server" ID="dlAvatarList" 
