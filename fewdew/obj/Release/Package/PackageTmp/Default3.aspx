<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default3.aspx.cs" Inherits="BDDoctors._Default3" %>
...
<body  >
    ...
    <div class="dvMain" >
<%--<img src="Images/Site/BlackDrop.jpg" style=" z-index:2;top:140px;position:absolute;" alt="Logo" style="float:left" />
--%><%--<span style="z-index:2;top:300px;position:absolute;left:230px;font-size:30px; font-weight:bold; color:#007996; ">Fewdew</span>
<span style="z-index:2;top:350px;position:absolute;left:150px;font-size:13px; font-weight:bold; color:black; ">Today's bindings , future society</span>--%>
     <span style="font-size:15px; color:#56AFC6" >Trial period is going. Your advice is highly appreciated. You can contact with the developer at <b>  webapper@gmail.com </b>  </span>
           ...
           <div style="margin-left:30%;margin-right:30%;margin-top:20%;" >
            ...
            <div class="signin-footer" style="width:100%; height:50px; position:absolute;bottom:0px;background-color:black; float:left;" >&nbsp<a href="Blog.aspx" >Blogs</a> || <a href=TreatmentPanel.aspx >Prescription point</a> <span style="float:right">© 2009 Fewdew. All rights reserved.</span> </div>
